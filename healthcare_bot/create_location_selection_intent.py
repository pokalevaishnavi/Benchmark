...
def create_location_selection_intent():
    ...
    output_context = dialogflow.Context(
        name=f"projects/{project_id}/agent/sessions/-/contexts/awaiting-location-confirmation",
        lifespan_count=5
    )
    ...
    try:
        ...
        print("Select location created successfully.")
...
create_location_selection_intent()
